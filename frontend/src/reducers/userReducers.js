import {
  ...
  USER_UPDATE_PROFILE_PICTURE_RESET,
...
export const userUpdateProfilePictureReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case USER_UPDATE_PROFILE_PICTURE_FAIL:
      return { loading: false, error: action.payload }
    case USER_UPDATE_PROFILE_PICTURE_RESET:
      return {}
    default:
      return state
  }
...
export const userForgotPasswordReducer = (state = { user: {} }, action) => {
  switch (action.type) {
...
export const adminUserForgotPasswordReducer = (
  state = { user: {} },
  action
) => {
  switch (action.type) {
    case ADMIN_USER_FORGOT_PASSWORD_REQUEST:
      return { loading: true }
    case ADMIN_USER_FORGOT_PASSWORD_SUCCESS:
      return { loading: false, success: true }
    case ADMIN_USER_FORGOT_PASSWORD_FAIL:
      return { loading: false, error: action.payload }
    case ADMIN_USER_FORGOT_PASSWORD_RESET:
      return {}
    default:
      return state
  }
